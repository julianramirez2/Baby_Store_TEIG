                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <h2 class="fw-bold mb-2 text-uppercase">Editar producto {{$product->id}}</h2>
                            ...
                            <form method="POST" action="{{route('productsAdmin.update',$product->id)}}">
                                ...
                                <div class="form-outline form-white mb-4">
                                    ...
                                    <label class="form-label" for="typePasswordX" " placeholder="{{$product->description}}">Descripcion</label>
                                </div>
